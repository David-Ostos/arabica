...
<template>
  ...
  <div class="h-screen w-screen bg-gray-100 flex items-center">
    ...
    >
      <div class="max-w-md">
        <div class="text-5xl font-dark font-bold  text-rose-600">404</div>
        ...
        <NuxtLink
          to='/'
          class="px-4 inline py-2 text-sm shadow-md font-medium leading-5 text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-primary active:bg-primary-600 hover:bg-primary-700"
        >
