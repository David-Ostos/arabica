...
<template>
  <div class="bg-[url('/img/hero.jpg')] bg-cover h-[120vh] w-full absolute top-0 flex justify-center items-center ">
    <div class="text-center max-w-[1100px] backdrop-blur-sm px-4">
